package com.example.peter.coffeekeeper.util;
...
public class BillingManager implements PurchasesUpdatedListener {
     ...
     */
    private final static String key1 = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAtOyGCmSb4/cXMJVMR1fDjk9fpLECdgKBJuq5iBq1wgYHjE6wKbEvxGPkShtVm";
    private final static String key2 = "Cbe3Yvw+czPO5QcgZQZSAcCwPTzXXjIFYSUlul7lSp9xiUuZB3zZPF/";
    private final static String key3 = "rMCuDK5DK1bgvNkdCN6iI/HjCc6eIJ2/FAFjwsgODM5+nC";
    private final static String key4 = "JGS8SQFi4BnlT6egCTiWRV78zSxiotJGrNSVcnIjnLHjwxXAV6sLHXYTaxOmz4nIfv/mISN+sSynKwA6mDknlo7bt858lUya9E6Isxnnz21oh0nn/eWlQIDuT0+r7DsDc";
    private final static String key5 = "4jnzDYT7VQzXsc0Ubk2oMuPkdvdjomn1DQOVG9nFpgKuCnw6RbQIDAQAB";
    private static final String BASE_64_ENCODED_PUBLIC_KEY = key1 + key2 + key3 + key4 + key5;
